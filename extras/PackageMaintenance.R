...
OhdsiRTools::checkUsagePackage("PPIandH2RA")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
shell("rm extras/PPIandH2RA.pdf")
shell("R CMD Rd2pdf ./ --output=extras/PPIandH2RA.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("PPIandH2RA")

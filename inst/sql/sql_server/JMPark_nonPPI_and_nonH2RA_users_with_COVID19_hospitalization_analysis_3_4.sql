...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (37311061) --40316526 influenza / 37311061 covid19
...
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (43009003)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (904453,948078,929887,911735,923645,43009052,19039926)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (904453,948078,929887,911735,923645,43009052,19039926)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (961047,997276,953076,950696,43009003)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (961047,997276,953076,950696,43009003)
  and c.invalid_reason is null
...
WHERE C.visit_start_date >= DATEFROMPARTS(2019, 12, 30)

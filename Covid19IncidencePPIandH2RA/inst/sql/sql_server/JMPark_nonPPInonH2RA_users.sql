...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (911735,948078,923645,904453,929887,19039926,43009052)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (911735,948078,923645,904453,929887,19039926,43009052)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (961047,950696,43009003,953076,997276)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (961047,950696,43009003,953076,997276)
  and c.invalid_reason is null
...
WHERE (C.drug_exposure_start_date >= DATEFROMPARTS(2019, 10, 31) and C.drug_exposure_start_date <= DATEFROMPARTS(2020, 01, 30))

...
controlFile <- system.file("settings", "NegativeControls.csv", package = "Covid19IncidencePPIandH2RA")
...
tcs <- read.csv(system.file("settings", "TcosOfInterest.csv", package = "Covid19IncidencePPIandH2RA"))[, c("targetId", "comparatorId")]

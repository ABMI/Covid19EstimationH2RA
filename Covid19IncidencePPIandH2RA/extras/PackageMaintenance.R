...
OhdsiRTools::checkUsagePackage("Covid19IncidencePPIandH2RA")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
shell("rm extras/Covid19IncidencePPIandH2RA.pdf")
shell("R CMD Rd2pdf ./ --output=extras/Covid19IncidencePPIandH2RA.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "Covid19IncidencePPIandH2RA")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("Covid19IncidencePPIandH2RA")

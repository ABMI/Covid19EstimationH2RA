...
2. In `R`, use the following `devtools` command to install the Covid19IncidencePPIandH2RA package:
...
3. Once installed, you can execute the study by modifying and using the code below. For your convenience, this code is also provided under `extras/CodeToRun.R`:
	...
	```r
	library(Covid19IncidencePPIandH2RA)
	...
	outputFolder <- "c:/Covid19IncidencePPIandH2RA"
...
License
=======
The Covid19IncidencePPIandH2RA package is licensed under Apache License 2.0

Development
===========
Covid19IncidencePPIandH2RA was developed in ATLAS and R Studio.

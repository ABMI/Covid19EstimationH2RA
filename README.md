...
2. In `R`, use the following `devtools` command to install the PPIandH2RA package:
...
License
=======
The PPIandH2RA package is licensed under Apache License 2.0

Development
===========
PPIandH2RA was developed in ATLAS and R Studio.

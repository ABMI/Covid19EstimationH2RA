...
2. In `R`, use the following `devtools` command to install the PPIandH2RACovid19Complication package:
...
3. Once installed, you can execute the study by modifying and using the code below. For your convenience, this code is also provided under `extras/CodeToRun.R`:
	...
	```r
	library(PPIandH2RACovid19Complication)
	...
	outputFolder <- "c:/PPIandH2RACovid19Complication"
...
License
=======
The PPIandH2RACovid19Complication package is licensed under Apache License 2.0

Development
===========
PPIandH2RACovid19Complication was developed in ATLAS and R Studio.

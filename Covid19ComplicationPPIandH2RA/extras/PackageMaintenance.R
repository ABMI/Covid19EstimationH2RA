...
OhdsiRTools::checkUsagePackage("PPIandH2RACovid19Complication")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
shell("rm extras/PPIandH2RACovid19Complication.pdf")
shell("R CMD Rd2pdf ./ --output=extras/PPIandH2RACovid19Complication.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "PPIandH2RACovid19Complication")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("PPIandH2RACovid19Complication")

...
controlFile <- system.file("settings", "NegativeControls.csv", package = "PPIandH2RACovid19Complication")
...
tcs <- read.csv(system.file("settings", "TcosOfInterest.csv", package = "PPIandH2RACovid19Complication"))[, c("targetId", "comparatorId")]
